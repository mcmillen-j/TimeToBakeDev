...
public class RecipePastriesAdapter extends FirebaseRecyclerAdapter<
    ...
    onBindViewHolder(@NonNull recipesViewholder holder,
        ...
        if ((model.getCategory().contentEquals("Pastries") && (timeSelected.contentEquals("No time selected"))) && (levelSelected.contentEquals("No level selected"))) {
        ...
        } else if (model.getCategory().contentEquals("Pastries") && (model.getTime().contentEquals(timeSelected)) && (levelSelected.contentEquals("No level selected"))) {
            holder.recipeName.setText(model.getRecipeName());
            holder.recipeTime.setText(model.getTime());
            holder.recipeLevel.setText(model.getLevel());
            String link = model.getImage();
        ...
        } else if (model.getCategory().contentEquals("Pastries") && (timeSelected.contentEquals("No time selected")) && (model.getLevel().contentEquals(levelSelected))) {
            holder.recipeName.setText(model.getRecipeName());
            holder.recipeTime.setText(model.getTime());
            holder.recipeLevel.setText(model.getLevel());
            String link = model.getImage();
        ...
        } else if (model.getCategory().contentEquals("Pastries") && (model.getTime().contentEquals(timeSelected)) && (model.getLevel().contentEquals(levelSelected))) {
            holder.recipeName.setText(model.getRecipeName());
            holder.recipeTime.setText(model.getTime());
            holder.recipeLevel.setText(model.getLevel());
            String link = model.getImage();
